...
func WithLevelExecExtra(items []*ExecExtraItem) []*ExecExtraItem {
	return append(items, NewExecExtraItem("level", "int"))
}

func WithLogtimeExecExtra(items []*ExecExtraItem) []*ExecExtraItem {
	return append(items, NewExecExtraItem("logtime", "bigint"))
}

func WithMessageExecExtra(items []*ExecExtraItem) []*ExecExtraItem {
	return append(items, NewExecExtraItem("message", "varchar(1024)"))
}

func WithDataExecExtra(items []*ExecExtraItem) []*ExecExtraItem {
	return append(items, NewExecExtraItem("data", "text"))
}
